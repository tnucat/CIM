...
/**
 * Annotated java for Transformer
...
public class Transformer
{
     ...
     */
    @Entity
    @Table(name="\"PowerTransformer1\"")
    @Inheritance(strategy=InheritanceType.JOINED)
    public static class PowerTransformer1
    {
        public String getMRID () { return mRID; }
        public void setMRID ( String mRID ) { this.mRID = mRID; }
        @Id
     ...
     */
    @Entity
    @Table(name="\"RatioTapChanger1\"")
    @PrimaryKeyJoinColumn(name="\"mRID\"")
    public static class RatioTapChanger1 extends TapChanger
    {
        /**
    ...
    @PrimaryKeyJoinColumn(name="\"mRID\"")
    public static class TapChangerControl extends RegulatingControl
    {
    }
    /**
     * Describes behaviour specific to tap changers, e.g. how the voltage at the
     ...
     */
    @Entity
    @Table(name="\"TransformerTank1\"")
    @Inheritance(strategy=InheritanceType.JOINED)
    public static class TransformerTank1
    {
        public String getMRID () { return mRID; }
        public void setMRID ( String mRID ) { this.mRID = mRID; }
        @Id
